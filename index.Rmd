...
#### Utilizando os dados de queimadas no estado do Rio de Janeiro em 2025 para exemplificar a aplicação de modelos de regressão espacial.
...
- Colocando a variável `media_dias_sem_chuva`
...
- Colocando algumas variáveis explicativas
...
- Prim eiro vamos extrair as coordenadas dos centróides dos municípios do estado do Rio de Janeiro
