...
subtitle: "Análise Espacial em Dados de Área (AEDA)"
...
- As variáveis doa tabela que será utilizada para o trabalho é [`dados_tocantins_aeda.csv`](dados/dados_tocantins_aeda.csv) e [`dados_tocantins_aeda.xlsx`](dados/dados_tocantins_aeda.xlsx) são:
...
1. **Escolha de dados:** Selecione um tema que tenha interesse e dados disponíveis. Dados simulados com padrão espacial bem definido também são aceitos.

2. **Reprodutibilidade:** Certifique-se de que todo o código está comentado e que alguém consegue reproduzir sua análise executando o arquivo `.qmd`.

3. **Visualizações:** Mapas e gráficos são fundamentais. Use cores apropriadas e legendas claras.

4. **Interpretações:** Não apenas apresente os resultados, mas **interprete-os**. O que significam os valores de Moran I? Quais são os clusters identificados? Por que um modelo é melhor que outro?

5. **Limitações:** Seja honesto sobre as limitações do seu trabalho. Nenhuma análise é perfeita.

---

## 📬 Dúvidas e Suporte

Em caso de dúvidas ou dificuldades técnicas, entre em contato por e-mail: **tassinari@ufrrj.br**
